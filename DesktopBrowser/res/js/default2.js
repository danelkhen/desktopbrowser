...
dbr.DefaultPage2.prototype.DefaultClient_Load = function (){
...
dbr.DefaultPage2.prototype.WriteLine = function (obj){
...
dbr.DefaultPage2.prototype.CanMoveSelection = function (by){
    return this.MoveSelection(by, false);
};
dbr.DefaultPage2.prototype.MoveSelection = function (by, preview){
    var by2 = by;
...
dbr.DefaultPage2.prototype.Select = function (row){
...
dbr.DefaultPage2.prototype.PageDown = function (){
    return this.MoveSelection(this.PageSize * 1, false);
};
dbr.DefaultPage2.prototype.PageUp = function (){
    return this.MoveSelection(this.PageSize * -1, false);
};
dbr.DefaultPage2.prototype.Enter = function (){
...
dbr.DefaultPage2.prototype.SelectFirstItem = function (){
...
dbr.DefaultPage2.prototype.Down = function (){
    if (!this.MoveSelection(1, false))
        return this.SelectFirstItem();
    return false;
};
dbr.DefaultPage2.prototype.Up = function (){
    if (!this.MoveSelection(-1, false))
        return this.SelectFirstItem();
    return false;
};
dbr.DefaultPage2.prototype.RestoreSelection = function (){
...
dbr.DefaultPage2.prototype.GetStorageItem = function (key){
    return this.win.localStorage.getItem(key);
};
dbr.DefaultPage2.prototype.SetStorageItem = function (key, value){
    this.win.localStorage.setItem(key, value);
};
dbr.DefaultPage2.prototype.SaveSelection = function (filename){
    var folder = $("#tbFilename").val();
...
dbr.DefaultPage2.prototype.Execute = function (path){
    new dbr.SiteProxy().Execute(path, null);
};
dbr.DefaultPage2.prototype.OpenFile = function (path){
    new dbr.SiteProxy().Execute(path, null);
};
dbr.DefaultPage2.prototype.GetSelectedPath = function (){
    if (this.Selector.SelectedItem == null)
        return null;
    var filePath = $(this.Selector.SelectedItem).find(".ihFilePath").val();
    return filePath;
};
dbr.DefaultPage2.prototype.btnDelete_click = function (){
...
dbr.DefaultPage2.prototype.Filter = function (el, exp){
    var x = $(el);
    x.parents("tr").first().toggle(x.text().search(exp) >= 0);
};
dbr.DefaultPage2.prototype.tbFolder_keydown = function (e){
    if (e.keyCode == 13){
        this.Go();
    }
};
dbr.DefaultPage2.prototype.Go = function (){
    var newPath = $("#tbFolder").val();
    this.win.location.href = "?p=" + encodeURIComponent(newPath);
};
dbr.DefaultPage2.prototype.btnGo_click = function (e){
    this.Go();
};
dbr.DefaultPage2.prototype.tbSearch_keyup = function (e){
...
dbr.DefaultPage2.prototype.SimulateClick = function (anchor){
    var a = $(anchor);
