...
<%--    <div>
        ...
        <form method="get" action="Default.aspx" class="form-horizontal">
            <div class="form-group row-full">
                <div class="col-md-11">
                    <input class="form-control" type="text" id="tbFolder" onkeydown="_page.tbFolder_keydown(event);" name="p" />
                </div>
                <div class="col-md-1">
