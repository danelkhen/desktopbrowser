...
(function () {
    ...
    Function.prototype.applyNew = function (args) {
        ...
        throw new Error("Function.prototype.applyNew doesn't support more than 11 parameters, you have "+count);
    }
...
(function () {
    ...
    Array.prototype.removeRange = function (items) {
        var _this = this;
        items.forEach(function (t) { _this.remove(t); });
    }
    ...
    Array.prototype.avgOrZero = function () {
        return this.avg() || 0;
    }
