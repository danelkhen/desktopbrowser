...
import "../../client/lib/corex-js/corex"
import { TmdbApi } from "./api2"
...
let x = new Proxy<TmdbApi>();
x.onInvoke = pc => {
    console.log({ pc });
    let url = 'https://api.themoviedb.org/3' + '/movie/latest';
    let prms = { api_key: '16a856dff4d1db46782e6132610ddb32' }
    return xhr2({ url, params: prms })
        .then(e => console.log(e));
};
x.invoke(t => t.getMovieLatest());
