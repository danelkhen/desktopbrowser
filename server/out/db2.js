...
async function main() {
    ...
    let client = await mongodb_1.MongoClient.connect(url);
...
class Db {
    ...
    get byFilename() { return this.connection && this.connection.collection("ByFilename"); }
    get keyValue() { return this.connection && this.connection.collection("KeyValue"); }
    get fsEntries() { return this.connection && this.connection.collection("FsEntry"); }
}
exports.Db = Db;
//async function test() {
