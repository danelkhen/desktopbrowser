...
exports.dateToDefaultString = exports.objectTryGet = void 0;
// import fs from "fs"
...
//     x.splice(index, 1)
// }
function objectTryGet(obj, indexers) {
...
exports.objectTryGet = objectTryGet;
...
function dateToDefaultString(dt) {
    let defaultDateFormat = "YYYY-MM-DD hh:mm:ss";
    return moment_1.default(dt).format(defaultDateFormat);
}
