...
export class TmdbClientV4 extends TmdbApiClient {
    constructor() {
        ...
        //            pc.args[0] = prm;
        //        }
        //        if (prm.session_id == null && this.access_token != null)
        //            prm.session_id = this.access_token;
    ...
    _loginToTmdb(): Promise<any> {
        return new Promise<any>((resolve, reject) => {
            window.addEventListener("message", e => {
                ...
                this.invoke(t => t.auth_access_token({  }))
                    .then(e => {
            ...
            this.invoke(t => t.auth_request_token({})).then(e => {
